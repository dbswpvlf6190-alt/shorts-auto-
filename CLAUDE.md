...
## 2026-09-23 — 인스타 미게시분(19·29·30번) 캐치업 완료 + 데스크톱 ntfy 연결
...
- **⚠️ 주의: 유튜브 쪽은 손대지 않음** — 19·29·30번의 유튜브 영상은 원래 그날(9/6·9/12·9/13) 업로드된 **옛 목소리(M3 이전 복제 음성)** 그대로다. 인스타만 최신 M3 목소리로 새로 올라가서 **같은 항목인데 유튜브와 인스타의 나레이션 목소리가 다름**. 이미 몇 주간 조회수가 쌓인 영상이라 임의로 비공개+재업로드하지 않았음 — 36번처럼 유튜브도 교체할지는 사용자 판단 필요(원하면 `_rerender_item.py`가 만든 렌더로 신규 업로드 가능).
