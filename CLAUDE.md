...
아래 두 영상은 **의도적으로 비공개** 상태입니다. "이 채널은 항상 공개가 기본"이라는 평소 정책과 다르지만, 예외 상황이니 일반 정책 판단으로 되돌리지 말 것 — 실제로 2026-09-12~18 사이에 이유를 모른 채 공개로 되돌려져서 결함 있는 영상이 조회수 247회를 찍은 사고가 있었음.
